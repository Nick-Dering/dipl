...
use Yii;
use backend\models\Specialties;
use backend\models\search\SpecialtieSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * SpecialtieController implements the CRUD actions for Specialties model.
 */
class SpecialtieController extends SiteController
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new SpecialtieSearch();
